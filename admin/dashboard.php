...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Dashboard
        <small>Información sobre el servicios</small>
      </h1>
    </section>
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-lg-3 col-xs-6">
                <?php
                    $sql = "SELECT COUNT(total_pagado) AS mapa_bcn FROM registrados WHERE pagado = 1 ";
                    $resultado = $conn->query($sql);
                ...
                ?>
                 <!-- small box -->
                  <div class="small-box bg-teal">
                    <div class="inner">
                      <h3><?php echo $regalo['mapa_bcn']; ?></h3>
            ...
            <div class="col-lg-3 col-xs-6">
                <?php
                    $sql = "SELECT COUNT(total_pagado) AS guia_bcn FROM registrados WHERE pagado = 2 ";
                    $resultado = $conn->query($sql);
                    $regalo = $resultado->fetch_assoc();
                ...
                ?>
                 <!-- small box -->
                  <div class="small-box bg-maroon">
                    <div class="inner">
                      <h3><?php echo $regalo['guia_bcn']; ?></h3>
            ...
            <div class="col-lg-3 col-xs-6">
                <?php
                    $sql = "SELECT COUNT(total_pagado) AS wifi FROM registrados WHERE pagado = 3 ";
                    $resultado = $conn->query($sql);
                    $regalo = $resultado->fetch_assoc();
