  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="lista-servicio.php"><i class="fa fa-list-ul" aria-hidden="true"></i> Ver Todos</a></li>
          <li><a href="crear-servicio.php"><i class="fa fa-plus-circle" aria-hidden="true"></i> Agregar</a></li>
        </ul>
      </li>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="lista-taxis.php"><i class="fa fa-list-ul" aria-hidden="true"></i> Ver Todos</a></li>
          <li><a href="crear-taxi.php"><i class="fa fa-plus-circle" aria-hidden="true"></i> Agregar</a></li>
        </ul>
      </li>
    ...
    <?php endif; ?>
      ...
      <li class="treeview">
        <a href="#">
          ...
          <span>Testimoniales</span><!--gente que ha usado el servicio y deja su testimonio-->
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
