                              ...
                              <div class="box-body">
                                              ...
                                              <li class="col-md-4">
                                                    <div class="tabla-precio text-center">
                                                        ...
                                                        <div class="orden">
                                                            ...
                                                            <input value="<?php echo $pases['un_dia']['cantidad']; ?>" type="number" class="form-control" min="0" id="pase_dia" size="3" name="pases[un_dia][cantidad]" placeholder="0">
                                              ...
                                              <li class="col-md-4">
                                                    <div class="tabla-precio text-center">
                                                        ...
                                                        <div class="orden">
                                                            ...
                                                            <input  value="<?php echo $pases['pase_completo']['cantidad']; ?>" type="number" class="form-control" min="0" id="pase_completo" size="3" name="pases[completo][cantidad]" placeholder="0">
                                              ...
                                              <li class="col-md-4">
                                                    <div class="tabla-precio text-center">
                                                        ...
                                                        <div class="orden">
                                                            ...
                                                            <input  value="<?php echo $pases['pase_2dias']['cantidad']; ?>" type="number" class="form-control" min="0" id="pase_dosdias" size="3" name="pases[2dias][cantidad]" placeholder="0">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="servicios" class="servicios clearfix">
                                                 <div class="caja ">
                                                        <?php
                                                            $servicios = $registrado['servicios_registrados'];
                                                            $id_servicios_registrados = json_decode($servicios, true);
                                                               ...
                                                               <?php foreach($servicios['servicios'] as $tipo => $servicios_dia): ?>
                                                                   <div class="col-md-4">
                                                                         ...
                                                                         <?php foreach($servicios_dia as $servicios) { ?>
                                                                           <label>
                                                                                <input <?php echo (in_array( $servicios['id'], $id_servicios_registrados['servicios']) ? 'checked' : '' ); ?> type="checkbox" class="minimal" name="registro_servicios[]" id="<?php echo $servicios['id']; ?>" value="<?php echo $servicios['id']; ?>">
                                                ...
                                                <div class="caja clearfix row">
                                                      <div class="extras col-md-6">
                                                            <div class="orden">
                                                                ...
                                                                <input value="<?php echo $pases['pedido_sagrada']; ?>" type="number" class="form-control" min="0" id="entrada_sagrada" name="pedido_extra[pedido_sagrada][cantidad]" size="3" placeholder="0">
                                                            ...
                                                            <div class="orden">
                                                                ...
                                                                <input value="<?php echo $pases['pedido_guell']; ?>" type="number" class="form-control" min="0" id="pedido_guell" name="pedido_extra[pedido_guell][cantidad]" size="3" placeholder="0">
                                                            ...
                                                            <div class="orden">
                                                                ...
                                                                <select id="regalo" name="regalo" required class="form-control seleccionar">
                                                                    ...
                                                                    <option value="2" <?php echo ($registrado['regalo'] == 2 ) ? 'selected' : '' ?>  >pedido_guell</option>
                                                                    <option value="1" <?php echo ($registrado['regalo'] == 1 ) ? 'selected' : '' ?>  >mapa_bcn</option>
                                                                    <option value="3" <?php echo ($registrado['regalo'] == 3 ) ? 'selected' : '' ?>  >wifi</option>
                                                                </select>
                                                            </div><!--.orden-->
                                                            <br>
